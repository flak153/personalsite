...
date: "2025-05-31"
description: "Learn how to dynamically add user permissions to Auth0 ID tokens using post-login Actions."
tags: ["auth0", "actions", "permissions", "javascript", "authentication", "authorization", "id token"]
---
