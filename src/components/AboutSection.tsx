...
const socialLinks = [
  {
    ...
    ariaLabel: "Visit Mohammed Ali's GitHub profile (opens in new tab)",
    icon: (
  ...
  },
  {
    ...
    ariaLabel: "Visit Mohammed Ali's LinkedIn profile (opens in new tab)",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    <section className="relative py-16 px-8 md:px-16 z-10" id="about" aria-labelledby="about-heading">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border border-white/40 rounded-lg p-8 bg-black/20 backdrop-blur-sm">
          <h3 className="text-xl font-bold mb-4 text-white">Senior Engineer & Startup Veteran</h3>
          <p className="text-white/90 text-lg mb-4">
            I&apos;m a product-minded engineer with a track record of building and scaling software at early-stage startups. 
            I thrive on turning ambitious ideas into robust, production-ready systems. My expertise lies in architecting scalable 
            cloud infrastructure, automating development with CI/CD, and ensuring security and compliance from day one.
          </p>
          ...
          <div className="flex justify-between items-center">
            ...
            <a 
              ...
              aria-label="Get in touch with Mohammed Ali"
            >
              Get in Touch
            </a>
          </div>
