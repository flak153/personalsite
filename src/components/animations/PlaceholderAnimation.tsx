...
const PlaceholderAnimation = ({ 
  ...
  // Move drawPlaceholderIcon above useEffect to ensure it is initialized before being used in the dependency array
  const drawPlaceholderIcon = useCallback((
  ...
  }, [title, description, drawPlaceholderIcon]);
